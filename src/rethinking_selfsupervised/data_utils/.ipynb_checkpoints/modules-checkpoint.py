...
class SOFARDataModule(LightningDataModule):
    ...
    def num_classes(self):
        return 11 #100 #64, 100

    @property
    def mean(self):
        return (0.5071, 0.4867, 0.440)
    ...
    def setup(self, stage=None): # called on every GPU
        ...
        val_data_dir = os.path.join(self.data_dir, 'test')
    ...
    def default_transform(self):
        transform = transform_lib.Compose([
            transform_lib.Resize((550, 550)),
            transform_lib.RandomCrop(448, padding=8),
...
class CIFARFSDataModule(LightningDataModule):
